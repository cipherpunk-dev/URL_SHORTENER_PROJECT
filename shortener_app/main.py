...
def raise_not_found(request):   #just for my convenience , helper function kinda
...
def get_admin_info(db_url: models.URL) -> schemas.URLInfo: #helper and string manipulation 
